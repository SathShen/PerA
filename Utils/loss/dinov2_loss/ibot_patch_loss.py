...
class iBOTPatchLoss(nn.Module):
    ...
    def softmax_center_teacher(self, teacher_patch_tokens, teacher_temp):
        self.center = self.center.to(teacher_patch_tokens.device)
    ...
    def apply_center_update(self):
        if self.updated is False:
            ...
            _t = self.async_batch_center / (self.len_teacher_patch_tokens * world_size)  # sum and average for all GPUs
